//Modified to get the correct iMICROS_PER_TICK
//defined variable iMICROS_PER_TICK and called function getMICROS_PER_TICK();
#include <Arduino.h>
...
bool IRrecv::decodeMagiQuest() {
    ...
    while (offset + 1 < decodedIRData.rawDataPtr->rawlen) {
        ...
        DEBUG_PRINT("mark=");
        DEBUG_PRINT(mark_ * iMICROS_PER_TICK);
        DEBUG_PRINT(" space=");
        DEBUG_PRINT(space_ * iMICROS_PER_TICK);
        DEBUG_PRINT(" ratio=");
