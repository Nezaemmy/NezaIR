 ...
 */
// MultiIR_Mod: removed irparams def and adding global variable - list of irparams_struct to go thru in interruption cycle
...
#endif
    lst_of_irparams.Add(&irparams); // MultiIR_Mod: add our instance to global list
}
...
void ProcessOneIRParam(irparams_struct &irparams); //MultiIR_Mod
